...
namespace margelo::nitro::math::bridge::swift {
  ...
  std::shared_ptr<HybridMathSpec> create_std__shared_ptr_HybridMathSpec_(void* _Nonnull swiftUnsafePointer) noexcept;
  void* _Nonnull get_std__shared_ptr_HybridMathSpec_(std__shared_ptr_HybridMathSpec_ cppType) noexcept;
