		...
		<BackgroundLayout className={cn("px-4 pb-4", Platform.OS === "ios" && "pt-0")} style={{ paddingTop: insets.top }}>
			<View className={cn("flex-row items-center justify-between bg-background pb-6")}>
				<View className="w-24 p-2">
					...
					>
						<Text className="text-sm font-semibold text-backgroundChat">Annuler</Text>
					</TouchableOpacity>
				</View>

				<Text className="text-lg font-bold text-primary">Nouvelle réservation</Text>
				...
				>
					{mutation.isPending ? (
						...
						<Text className={cn("text-sm font-semibold text-backgroundChat", !isAllGood && "text-primary/40")}>
							Créer
						</Text>
					)}
				</TouchableOpacity>
			...
			<Text className="text-xl font-bold text-primary">Choisir un créneau</Text>
