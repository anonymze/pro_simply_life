					...
					{(field) => (
						<React.Fragment>
							<TextInput
								...
								className="w-full rounded-lg bg-defaultGray/15 p-5 text-primary placeholder:text-primaryLight border border-transparent focus:border-primary"
					...
					{(field) => (
						<React.Fragment>
							<TextInput
								...
								className="min-h-24 w-full rounded-lg border border-transparent bg-defaultGray/15 p-5 text-primary placeholder:text-primaryLight focus:border-primary"
								defaultValue={field.state.value}
								onChangeText={field.handleChange}
							/>
						</React.Fragment>
