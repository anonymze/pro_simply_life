import Animated, { useSharedValue, useAnimatedProps, runOnJS, interpolate, withTiming, SharedValue, useAnimatedReaction, Easing, runOnUI, Extrapolation, } from "react-native-reanimated";
